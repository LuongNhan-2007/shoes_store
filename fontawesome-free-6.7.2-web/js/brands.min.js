...
(() => {
    ...
    function m(c, l, z) {
        ...
        })(l, "string")) ? h : h + "") in c ? Object.defineProperty(c, l, { value: z, enumerable: !0, configurable: !0, writable: !0 }) : c[l] = z
    }

    function s(l, c) { var z, h = Object.keys(l); return Object.getOwnPropertySymbols && (z = Object.getOwnPropertySymbols(l), c && (z = z.filter(function(c) { return Object.getOwnPropertyDescriptor(l, c).enumerable })), h.push.apply(h, z)), h }

    function C(l) {
        for (var c = 1; c < arguments.length; c++) {
            var z = null != arguments[c] ? arguments[c] : {};
            c % 2 ? s(Object(z), !0).forEach(function(c) { m(l, c, z[c]) }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(l, Object.getOwnPropertyDescriptors(z)) : s(Object(z)).forEach(function(c) { Object.defineProperty(l, c, Object.getOwnPropertyDescriptor(z, c)) })
        }
        return l
    }
    ...
    let L = (() => { try { return !0 } catch (c) { return !1 } })();

    function f(c) { return new Proxy(c, {get(c, l) { return l in c ? c[l] : c[v] } }) }
    var r = C({}, a);
