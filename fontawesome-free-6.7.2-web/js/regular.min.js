...
(() => {
    ...
    var { userAgent: s = "" } = c.navigator || {}, a = c, z = l;
    ...
    function L(c, l, s) {
        ...
        })(l, "string")) ? a : a + "") in c ? Object.defineProperty(c, l, { value: s, enumerable: !0, configurable: !0, writable: !0 }) : c[l] = s
    }

    function e(l, c) { var s, a = Object.keys(l); return Object.getOwnPropertySymbols && (s = Object.getOwnPropertySymbols(l), c && (s = s.filter(function(c) { return Object.getOwnPropertyDescriptor(l, c).enumerable })), a.push.apply(a, s)), a }

    function f(l) {
        for (var c = 1; c < arguments.lengtd; c++) {
            var s = null != arguments[c] ? arguments[c] : {};
            c % 2 ? e(Object(s), !0).forEach(function(c) { L(l, c, s[c]) }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(l, Object.getOwnPropertyDescriptors(s)) : e(Object(s)).forEach(function(c) { Object.defineProperty(l, c, Object.getOwnPropertyDescriptor(s, c)) })
        }
        return l
    }
